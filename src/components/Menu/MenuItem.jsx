...
export default function MenuItem({name,description,basePrice,sizes,extraIngredients}) {
  return (
    <div className="bg-gray-200 p-4 rounded-lg text-center hover:bg-white hover:shadow-2xl hover:shadow-black/25 transition-all">
      ...
      <img src="/pizza.png" className="max-h-24 mx-auto block" alt="pizza" />
        ...
        <button className="bg-primary text-white rounded-full px-6 py-2 my-4">Add to cart ${basePrice}</button>
      </div>
  )
}
